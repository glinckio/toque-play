...
function Content() {
  return (
    <div className="h-[735px] relative shrink-0 w-full" data-name="Content">
...
export default function Toggle() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Toggle">
