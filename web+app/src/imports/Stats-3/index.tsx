import svgPaths from "./svg-t6ry2gjdea";
...
function Frame11() {
  return (
    <div className="[word-break:break-word] absolute content-stretch flex flex-col gap-[4px] items-start justify-center leading-[normal] left-[16px] text-[#322d2d] top-[94px] whitespace-nowrap">
      <p className="font-['Bebas_Neue:Bold',sans-serif] not-italic relative shrink-0 text-[24px]">FIBA League</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[14px]">76ers</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 text-center">
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#322d2d] text-[14px] w-[80px]">76ers</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium relative shrink-0 text-[#848181] text-[12px] w-[80px]">11-20</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-[80px]">
...
function Frame21() {
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[24px] items-center justify-center leading-[normal] relative shrink-0 text-[#322d2d] text-center whitespace-nowrap">
      <p className="font-['Bebas_Neue:Bold',sans-serif] not-italic relative shrink-0 text-[38px]">95</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px]">Final</p>
      <p className="font-['Bebas_Neue:Bold',sans-serif] not-italic relative shrink-0 text-[38px]">92</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 text-center">
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#322d2d] text-[14px] w-[80px]">TR raptor</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium relative shrink-0 text-[#848181] text-[12px] w-[80px]">11-20</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[16px] top-[165px] w-[358px]">
      <Frame6 />
      <Frame21 />
      <Frame7 />
    </div>
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-[80px]">
      <p className="[word-break:break-word] font-['Manrope:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#150000] text-[14px] whitespace-nowrap">Stats</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 2">
...
function Frame19() {
  return (
    <div className="bg-[#150000] content-stretch flex gap-[24px] items-center p-[8px] relative shrink-0 w-[358px]">
      <div className="relative shrink-0 size-[24px]" data-name="58419ca3a6515b1e0ad75a64">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img58419Ca3A6515B1E0Ad75A64} />
      </div>
      <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#fafafa] text-[14px] whitespace-nowrap">76ers</p>
    </div>
  );
}
...
function Cells() {
  return (
    <div className="bg-[#150000] relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-white whitespace-nowrap">Summary</p>
        </div>
      </div>
    </div>
  );
...
function Cells1() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">Darcie Brown</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">Megan Schutt</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">Annabel land</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">Alana King</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">Saulo A. C.</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[123px]">
      <Cells />
      <Cells1 />
      <Cells2 />
      <Cells3 />
...
function Cells8() {
  return (
    <div className="bg-[#150000] relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-white whitespace-nowrap">MIN</p>
        </div>
      </div>
    </div>
  );
...
function Cells16() {
  return (
    <div className="bg-[#150000] relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-white whitespace-nowrap">PTS</p>
        </div>
      </div>
    </div>
  );
...
function Cells24() {
  return (
    <div className="bg-[#150000] relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-white whitespace-nowrap">REB</p>
        </div>
      </div>
    </div>
  );
...
function Cells32() {
  return (
    <div className="bg-[#150000] relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-white whitespace-nowrap">AST</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">4.75</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">5.75</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">14.0</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">11.0</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Cells">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[8px] py-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#150000] text-[12px]">
            <p className="leading-[normal]">4.32</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame13() {
  return (
    <div className="content-stretch flex items-start relative rounded-bl-[10px] shrink-0">
      <Frame12 />
      <Frame14 />
      <Frame15 />
      <Frame16 />
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[16px] top-[292px]">
      <Frame4 />
      <Frame19 />
      <Frame13 />
    </div>
    ...
    <div className="bg-[#d6d5d5] flex-[1_0_0] h-[32px] min-w-px relative">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Bebas_Neue:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#848181] text-[14px] whitespace-nowrap">TR raptor</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="bg-[#ff5050] flex-[1_0_0] h-[32px] min-w-px relative">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Bebas_Neue:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#fafafa] text-[14px] whitespace-nowrap">76ers</p>
        </div>
      </div>
    </div>
  );
...
export default function Stats() {
  return (
    <div className="bg-[#fafafa] relative size-full" data-name="Stats">
      <Frame />
      <Frame11 />
      <CarbonChevronLeft />
      <Frame10 />
