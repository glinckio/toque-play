...
function Content() {
  return (
    <div className="bg-white h-[1304px] mix-blend-multiply relative shrink-0 w-full" data-name="Content">
...
export default function Search() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Search">
