import svgPaths from "./svg-uj499b7c9v";
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[16px] top-[325px] w-[358px]">
      <Frame9 />
      <p className="[word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#150000] text-[16px] text-right whitespace-nowrap">FIFA Official Stats</p>
      <Frame19 />
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative">
      <div className="bg-[#ff5050] h-[4px] relative shrink-0 w-[77px]" />
      <div className="flex items-center justify-center relative shrink-0">
        <div className="-scale-y-100 flex-none">
          <div className="bg-[#d6d5d5] h-[4px] relative w-[77px]" />
        </div>
      </div>
      <div className="flex flex-[1_0_0] items-center justify-center min-w-px relative">
        <div className="-scale-y-100 flex-none w-full">
          <div className="bg-[#150000] h-[4px] relative w-full" />
        </div>
      </div>
    </div>
  );
...
function Frame21() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-[358px]">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">47%</p>
      <Frame22 />
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">41%</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0">
      <Frame21 />
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">13% in contest</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">Total</p>
      <Frame24 />
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0">
      <p className="[word-break:break-word] font-['Bebas_Neue:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#150000] text-[18px] text-right whitespace-nowrap">Attacking</p>
      <Frame25 />
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-[358px]">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">1</p>
      <Frame30 />
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">3</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative">
      <div className="bg-[#ff5050] h-[4px] relative shrink-0 w-[127px]" />
      <div className="flex flex-[1_0_0] items-center justify-center min-w-px relative">
        <div className="-scale-y-100 flex-none w-full">
          <div className="bg-[#150000] h-[4px] relative w-full" />
        </div>
...
function Frame32() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-[358px]">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">2</p>
      <Frame33 />
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">3</p>
    </div>
  );
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">Inside the penalty area</p>
      <Frame32 />
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative">
      <div className="bg-[#ff5050] h-[4px] relative shrink-0 w-[172px]" />
      <div className="flex flex-[1_0_0] items-center justify-center min-w-px relative">
        <div className="-scale-y-100 flex-none w-full">
          <div className="bg-[#150000] h-[4px] relative w-full" />
        </div>
...
function Frame34() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0">
      <p className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#150000] text-[12px] text-right whitespace-nowrap">Assists</p>
      <Frame35 />
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0">
      <p className="[word-break:break-word] font-['Bebas_Neue:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#150000] text-[18px] text-right whitespace-nowrap">Goal</p>
      <Frame29 />
      <Frame31 />
      <Frame34 />
    </div>
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[16px] top-[416px]">
      <Frame26 />
      <Frame27 />
    </div>
  );
