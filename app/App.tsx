...
import CreateSheetScreen from './src/screens/main/CreateSheetScreen';
            ...
            <NavigationContainer>
              {isAuthenticated ? (
                <RootStack.Navigator screenOptions={{ headerShown: false }}>
                  ...
                  <RootStack.Screen name="MyReferees" component={MyRefereesScreen} options={{ presentation: 'modal' }} />
                  <RootStack.Screen name="MyTournaments" component={MyTournamentsScreen} options={{ presentation: 'modal' }} />
                  <RootStack.Screen name="MyRegistrations" component={MyRegistrationsScreen} options={{ presentation: 'modal' }} />
                  <RootStack.Screen name="CreateSheet" component={CreateSheetScreen} options={{ presentation: 'formSheet', sheetAllowedDetents: [0.45], sheetCornerRadius: 24, sheetGrabberVisible: true }} />
