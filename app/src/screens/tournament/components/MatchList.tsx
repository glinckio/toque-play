...
const styles = StyleSheet.create({
  ...
  liveLabel: { fontSize: 11, fontFamily: fonts.text.bold, color: colors.error, letterSpacing: 1 },
  doneLabel: { fontSize: 11, fontFamily: fonts.text.bold, color: colors.success, letterSpacing: 0.5 },
  scheduledLabel: { fontSize: 11, fontFamily: fonts.text.semiBold, color: colors.textMuted, letterSpacing: 0.5 },
