    ...
    return (
      <SafeAreaView style={styles.root} edges={['top']}>
        <View style={styles.resultContainer}>
          ...
          <Text style={styles.resultText}>O pagamento não foi concluído.</Text>
...
const styles = StyleSheet.create({
  ...
  resultTitle: { fontFamily: fonts.title.display, fontSize: 28, color: colors.text, letterSpacing: 3, marginBottom: spacing.md },
