...
const s = StyleSheet.create({
  ...
  guestBadge: { fontSize: 8, fontFamily: fonts.text.bold, color: colors.textMuted, backgroundColor: 'rgba(0,0,0,0.05)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, letterSpacing: 1 },
