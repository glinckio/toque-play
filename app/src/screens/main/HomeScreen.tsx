...
export default function HomeScreen() {
  ...
  const featuredTournaments: Tournament[] = [
    ...(dashboard?.upcomingTournaments ?? []),
    ...(dashboard?.popularTournaments ?? []),
  ]
    .slice(0, 4)
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Section title="Torneios em destaque" cta="Explorar" onCta={() => rootNav.navigate('Main' as any, { screen: 'Explore' } as any)}>
